...
export interface Context<
    T extends 'artist' | 'playlist' | 'album' | 'track' | 'show' | 'episode'
> {
    /** The object type. */
    type: T
...
export interface CurrentlyPlaying {
    ...
    context: Context<'track'> | Context<'episode'> | null
...
export interface PlaylistTrack {
    ...
    added_by: Omit<PublicUser, 'display_name' | 'followers'> | null
...
export interface SimplifiedAlbum extends Context<'album'> {
    ...
    /** Included in the response when a content restriction is applied. See {@link Restriction} for more details. */
    restrictions?: Restriction
    /** This property is not currently on the official SpotifyAPI documentation */
    total_tracks: number
}
export interface SimplifiedArtist extends Context<'artist'> {
    /** The [Spotify ID](https://developer.spotify.com/documentation/web-api/#spotify-uris-and-ids) for the artist. */
    id: string
    /** The name of the artist. */
    name: string
}
export interface SimplifiedEpisode extends Context<'episode'> {
     ...
     * @deprecated This field is deprecated and might be removed in the future. Please use the {@link Episode.languages `languages`} field instead.
     */
    language: string
...
export interface SimplifiedPlaylist extends Context<'playlist'> {
    ...
    owner: Omit<PublicUser, 'followers'>
...
export interface SimplifiedShow extends Context<'show'> {
    /**
...
export interface SimplifiedTrack extends Context<'track'> {
